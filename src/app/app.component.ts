...
@Component({
    ...
    imports: [DisplayComponent, ExampleButtonComponent, ExampleFileComponent, MatFormField, MatLabel, MatInput, CdkTextareaAutosize, ReactiveFormsModule, FooterComponent]
})
